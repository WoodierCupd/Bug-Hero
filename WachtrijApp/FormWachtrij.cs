...
namespace WachtrijApp
{
    public partial class FormWachtrij : Form
    {
        ...
        private int BerekenWachttijd()
        {
            ...
            string node010 = doc.DocumentElement.SelectSingleNode("/Sensoren/Sensor08").InnerText;
            if (node010 == "False")
            {
                return Wachttijd;
            }
            ...
            string node011 = doc.DocumentElement.SelectSingleNode("/Sensoren/Sensor08").InnerText;
            if (node011 == "False")
            {
                return Wachttijd;
            }
            ...
            string node012 = doc.DocumentElement.SelectSingleNode("/Sensoren/Sensor08").InnerText;
            if (node012 == "False")
            {
                return Wachttijd;
            }
